   ...
   return (
      <>
         <Head>
            ...
            <meta name="description" content="Professional web development, AI integration, and digital services by Nakul Srivastava. Full-stack development, SEO optimization, and consultation services." />
            <meta name="keywords" content="Web Development Services, AI Integration, Full Stack Developer, SEO Services, Consultation, Nakul Srivastava" />
            <link rel="canonical" href="https://devnakul.me/services" />
         </Head>
            ...
            <div className="relative bg-gradient-to-b from-blue-900/20 to-transparent">
               ...
               <div className="relative z-10 max-w-6xl mx-auto px-4 py-20">
                  ...
                  <p className="text-xl text-gray-300 max-w-2xl">
                     Transform your ideas into powerful digital solutions with expert development and AI integration services
                  </p>
               </div>
            </div>
